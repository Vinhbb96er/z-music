    ...
    <div class="tab-pane active">
        ...
        <div class="album-inner">
            ...
            <h4 class="heading-2 media-header-title">
                <a href="#">
                    {{ $t('album.album_hot') }} <i class="fa fa-angle-right"></i>
                </a>
            </h4>
            ...
            <div class="tab-content">
                <div class="tab-pane active" v-for="album in mediaHot" :key="album.id">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions(['getMediaHot', 'addMusicToPlaylist', 'playingMusic'])
        },
        created() {
            this.getMediaHot({
                type: this.type,
